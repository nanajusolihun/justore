    ...
    <div>
      <div className="grid sm:px-10 lg:grid-cols-2 lg:px-20 xl:px-32">
        <div className="px-4 pt-8">
          ...
          <div className="mt-8 space-y-3 rounded-lg border bg-white px-2 py-5 sm:px-5">
            {cartItems && cartItems.length ? (
              cartItems.map((item, index) => (
                <div
                  className="flex flex-col rounded-lg shadow bg-gray-100 sm:flex-row"
                  key={index}
                >
                  <img
                  ...
                  <div className="flex w-full flex-col px-4 py-4">
                    ...
                    <span className="font-meduim text-gray-400">
                      {item && item.productID && item.productID.category}
                    </span>
                  </div>
                </div>
              ))
              ...
              addresses.map((item, index) => (
                <div
                  ...
                  className={`border p-6 ${
                    item._id === selectedAddress ? "bg-amber-300 rounded-lg shadow" : ""
                  }`}
                >

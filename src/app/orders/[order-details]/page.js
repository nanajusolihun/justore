    ...
    <div className="py-14 px-4 md:px-6">
      ...
      <div className="mt-10 flex flex-col justify-center xl:flex-row items-stretch w-full xl:space-x-8 md:space-y-6 xl:space-y-0">
        <div className="flex flex-col justify-start items-start w-full space-y-4 md:space-y-6 xl:space-y-8">
          <div className="flex flex-col justify-start items-start bg-gray-50 px-4 py-4 md:p-6 xl:p-8 w-full rounded-lg">
                  ...
                  >
                    ...
                    <div className="border-b border-gray-300 md:flex-row flex-col flex justify-between items-start w-full pb-8 space-y-4 md:space-y-0">
                      <div className="w-full flex flex-col justify-start items-start space-y-8">
                        ...
                        <h3 className="text-lg font-medium leading-none text-gray-400">
                          {item && item.product && item.product.category}
                        </h3>
                      </div>
                      <div className="w-full flex justify-between items-start space-x-8">
                        <h3 className="text-xl font-semibold leading-6 text-gray-900">
                          {FormatCurrency(item && item.product && item.product.price)}
                        </h3>
                      </div>
                    </div>
                  </div>
          ...
          <div className="flex justify-center flex-col md:flex-row items-stretch w-full space-y-4 md:space-y-0 md:space-x-5 xl:space-x-8">
            <div className="flex flex-col px-4 py-6 md:p-6 xl:p-8 w-full bg-gray-50 space-y-6 rounded-lg">
              <h3 className="text-xl font-semibold leading-6 text-gray-900 uppercase">
                Orders Summary
              </h3>
              <div className="flex justify-center items-center w-full space-y-4 flex-col border-gray-200 border-b pb-4">
                <div className="flex justify-between w-full">
                  ...
                  <p className="text-base leading-5 text-gray-900">
                    {FormatCurrency(orderDetails && orderDetails.totalPrice)}
                  </p>
                </div>
                <div className="flex justify-between w-full">
        ...
        <div className="flex flex-col gap-5">
          <div className="bg-gray-50 w-full xl:w-96 flex  items-center md:items-start px-4 py-6 flex-col rounded-lg">
            <h3 className="text-xl font-semibold leading-6 text-gray-900">
              Customer Details
            </h3>
